...
function HelpModal({ setShowModal }) {
  ...
  return (
    <Modal setShowModal={setShowModal}>
      ...
      <div className="h-full px-1 overflow-x-visible w-full overflow-y-scroll flex flex-col">
        <p className="font-bold w-full">
          Uhádni slovo, máš 6 pokusov. Pokus je:
        </p>
        ...
        <span className="italic text-sm mb-1 font-normal">Ani jedno z týchto písmen nie je v hľadanom slove</span>
        <span
